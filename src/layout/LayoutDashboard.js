  ...
  return (
    <div className="min-h-screen p-10 bg-lite">
      <ReactModal
        ...
        className="w-full modal-content max-w-[521px] bg-white rounded-2xl outline-none p-10 relative max-h-[90vh] overflow-y-auto scroll-hidden"
      >
        ...
        <h2 className="mb-10 font-bold text-center text-[25px]">Back this project</h2>
        <p className="mb-3 text-sm">Enter the contribution amount</p>
        <input
          type="text"
          placeholder="$10"
          name="amout"
        ...
        <Button className="px-6 text-white bg-primary">Continue</Button>
