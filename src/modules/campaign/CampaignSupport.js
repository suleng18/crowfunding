...
const CampaignSupport = () => {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col w-full px-6 bg-white py-7 shadow-1">
        <p className="mb-8 text-xl text-center text-text3">Pledge without reward</p>
        <Input
          placeholder="$10"
          control={control}
          name="Pledge"
        ...
        <div className="p-5 mb-5 bg-grayf3 rounded-xl">
          <p className="mb-5 text-sm font-semibold text-text2">Back it because you believe in it</p>
