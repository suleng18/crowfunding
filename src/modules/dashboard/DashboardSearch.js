...
const DashboardSearch = () => {
  ...
  return (
    <div className="relative z-50">
      <div className="flex items-center bg-white rounded-full shadow-[10px_10px_20px_rgba(218,_213,_213,_0.15)] p-2 w-full">
        ...
        <button className="w-[72px] flex justify-center items-center h-10 bg-primary rounded-full text-white flex-shrink-0 ">
          <svg
      ...
      {showSearch && (
        <div className="search-results w-full  lg:w-[843px] bg-white absolute top-full left-0 z-50 translate-y-5 pb-6 rounded-3xl">
          <div className="flex items-center justify-between p-3 bg-graySoft rounded-3xl">
            <h4 className="pl-4 text-sm font-medium underline">See all 10,108 fundraiser</h4>
...
function SearchItem() {
  return (
    <div className="flex items-center gap-x-5">
      <img src={defaultImage} alt="" className="w-[50px] h-[50px] rounded-lg object-cover" />
      <div className="flex-1 text-sm">
        <h3 className="mb-1">
          <strong>Education</strong> fund for Durgham Family
        </h3>
        <p className="text-text3">By SuLeng Family</p>
      </div>
    </div>
  );
}
